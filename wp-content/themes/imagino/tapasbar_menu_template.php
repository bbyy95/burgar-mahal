<?php /* Template Name: Tapas bar Template */ ?>
<?php get_header(); ?>

<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
<section class="menu-page-section inner-header container-fluid">
  <div class="container">
    <h3 class="top-head">MOSBACHER TAPAS BAR</h3>
    
    <div class="row">
      <div class="col-md-12">
        <div class="about-quote">
          <?php echo the_field('tapas_section'); ?>
        </div>
      </div>  
    </div> 
    ...
    <div class="row" style="margin-top: 23px;">
      <div class="col-md-6 top-box">
        <div class="box-inner" style="background: url('<?php bloginfo('template_directory')?>/asset/images/tapas.jpeg'); border-left: none">
        
        </div>
      </div>
      <div class="col-md-6 top-box">
        <div class="box-inner" style="background: url('<?php bloginfo('template_directory')?>/asset/images/menu_bg1.jpg')">
          <h4> Tapaz Bar Menu</h4>
